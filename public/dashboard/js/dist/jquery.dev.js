...
!function (a, b) {
  ...
  o.fn = o.prototype = {
    ...
    proxy: function proxy(a, b) {
      var c, d, f;
      return "string" == typeof b && (c = a[b], b = a, a = c), o.isFunction(a) ? (d = e.call(arguments, 2), f = function f() {
            ...
            return function () {
              var i = this === e ? void 0 : this,
                ...
                if (!(g > b)) {
                  ...
                  e = a && ("object" == _typeof(a) || "function" == typeof a) && a.then, o.isFunction(e) ? f ? e.call(a, h(g, c, J, f), h(g, c, K, f)) : (g++, e.call(a, h(g, c, J, f), h(g, c, K, f), h(g, c, J, c.notify))) : (d !== J && (i = void 0, j = [a]), (f || c.resolveWith)(i || c.promise(), j));
                }
              },
                  l = f ? k : function () {
                try {
  ...
  var O = function O(a, b, c, d, e, f, g) {
    var h = 0,
        i = a.length,
        j = null == c;
  ...
  Q.uid = 1, Q.prototype = {
    ...
    set: function set(a, b, c) {
      var d,
          e = this.cache(a);
      if ("string" == typeof b) e[o.camelCase(b)] = c;else for (d in b) {
        e[o.camelCase(d)] = b[d];
      }
      return e;
    },
  ...
  o.extend({
    ...
    clone: function clone(a, b, c) {
      ...
      if (!(l.noCloneChecked || 1 !== a.nodeType && 11 !== a.nodeType || o.isXMLDoc(a))) for (g = ha(h), f = ha(a), d = 0, e = f.length; e > d; d++) {
        Ba(f[d], g[d]);
      }
  ...
  o.Animation = o.extend(cb, {
    ...
    var e = a && "object" == _typeof(a) ? o.extend({}, a) : {
  ...
  o.extend(o.event, {
    trigger: function trigger(b, c, e, f) {
      ...
      if (h = i = e = e || d, 3 !== e.nodeType && 8 !== e.nodeType && !mb.test(q + o.event.triggered) && (q.indexOf(".") > -1 && (r = q.split("."), q = r.shift(), r.sort()), l = q.indexOf(":") < 0 && "on" + q, b = b[o.expando] ? b : new o.Event(q, "object" == _typeof(b) && b), b.isTrigger = f ? 2 : 3, b.namespace = r.join("."), b.rnamespace = b.namespace ? new RegExp("(^|\\.)" + r.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, b.result = void 0, b.target || (b.target = e), c = null == c ? [b] : o.makeArray(c, [b]), n = o.event.special[q] || {}, f || !n.trigger || n.trigger.apply(e, c) !== !1)) {
  ...
  }), l.focusin = "onfocusin" in a, l.focusin || o.each({
    focus: "focusin",
    blur: "focusout"
  }, function (a, b) {
    var c = function c(a) {
  ...
  function Kb(a, b, c, d) {
    ...
    if (o.isArray(b)) o.each(b, function (b, e) {
      c || Gb.test(a) ? d(a, e) : Kb(a + "[" + ("object" == _typeof(e) && null != e ? b : "") + "]", e, c, d);
  ...
  l.cors = !!Mb && "withCredentials" in Mb, l.ajax = Mb = !!Mb, o.ajaxTransport(function (b) {
    ...
    return l.cors || Mb && !b.crossDomain ? {
      send: function send(e, f) {
        ...
        _c = function c(a) {
          return function () {
            _c && (_c = d = h.onload = h.onerror = h.onabort = h.onreadystatechange = null, "abort" === a ? h.abort() : "error" === a ? "number" != typeof h.status ? f(0, "error") : f(h.status, h.statusText) : f(Lb[h.status] || h.status, h.statusText, "text" !== (h.responseType || "text") || "string" != typeof h.responseText ? {
              binary: h.response
            } : {
              text: h.responseText
  ...
  o.ajaxSetup({
    ...
    var d,
        ...
        g = this,
        h = a.indexOf(" ");
    return h > -1 && (d = o.trim(a.slice(h)), a = a.slice(0, h)), o.isFunction(b) ? (c = b, b = void 0) : b && "object" == _typeof(b) && (e = "POST"), g.length > 0 && o.ajax({
      url: a,
      type: e || "GET",
      dataType: "html",
      data: b
